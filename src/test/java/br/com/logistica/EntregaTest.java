...
class EntregaTest {
    ...
    void naoDeveCriarEntregaComEnderecoNulo() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega(null, 10, TipoFrete.PADRAO, "Destinatario");
        });
    ...
    void naoDeveCriarEntregaComEnderecoVazio() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega(" ", 10, TipoFrete.PADRAO, "Destinatario");
        });
    ...
    void naoDeveCriarEntregaComTipoFreteNulo() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega("Endereco", 10, null, "Destinatario");
        });
    ...
    void naoDeveCriarEntregaComDestinatarioNulo() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega("Endereco", 10, TipoFrete.PADRAO, null);
        });
    ...
    void naoDeveCriarEntregaComDestinatarioVazio() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega("Endereco", 10, TipoFrete.PADRAO, "  ");
        });
    ...
    void naoDeveCriarEntregaComPesoInvalido() {
        var ex = assertThrows(DadosInvalidosException.class, () -> {
            new Entrega("Endereco", 0, TipoFrete.PADRAO, "Destinatario");
        });
